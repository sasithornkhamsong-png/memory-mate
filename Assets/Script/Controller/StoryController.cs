    ...
    void Start()
    {
        allStories = new string[][]
        {
            ...
            new string[]
            {
                ...
                "แต่เอ๊ะ นั่นมันอะไร ตัวเลขเปลี่ยนไปงั้นหรอ ดังนั้น ให้คุณจำตัวเลขชุดแรกเอาไว้นะ",
                "แล้วอีกครู่ ตัวเลขจะเปลี่ยนไป อย่ากระพริบตา คุณจะต้องกำจัดตัวเลขที่ไม่ถูกต้องออกไปเสียก่อน"
